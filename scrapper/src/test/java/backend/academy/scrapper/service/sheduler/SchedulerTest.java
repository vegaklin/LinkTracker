...
class SchedulerTest {
    ...
    void checkCheckForUpdatesWithLinks() {
        ...
        links.put(1L, new Link("https://test.ru/1", List.of("tag1"), List.of("filter:filter1"), OffsetDateTime.of(2025, 3, 1, 12, 0, 0, 0, ZoneOffset.UTC)));
        links.put(2L, new Link("https://test.ru/2", List.of("tag2"), List.of("filter:filter2"), OffsetDateTime.of(2025, 3, 1, 12, 0, 0, 0, ZoneOffset.UTC)));
